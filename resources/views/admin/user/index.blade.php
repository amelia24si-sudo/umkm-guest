    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="mb-0">Daftar semua user yang terdaftar dalam sistem.</p>
            </div>
            <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->avatar)
                                                <img src="{{ asset('storage/avatars/' . $item->avatar) }}"
                                                    alt="Profile Picture" class="rounded-circle" width="40"
                                                    height="40">
                                            @else
                                        ...
                                        <td>
                                            @php
                                                ...
                                                $color = $roleColors[$item->role] ?? 'bg-secondary';
                                            @endphp
                                            <span class="badge {{ $color }}">{{ ucfirst($item->role) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <a href="{{ route('user.edit', $item->id) }}" class="btn btn-info btn-sm">
                                                    <svg class="icon icon-xs" data-slot="icon" fill="none"
